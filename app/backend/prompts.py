...
- Структура сильного ролика/текста: ПРОБЛЕМА -> ИСТОРИЯ -> РАЗВЯЗКА -> НЕДОСКАЗАННОСТЬ. Цепляй болью или интригой, разворачивай через живую историю, давай развязку и в конце оставляй открытую петлю (недосказанность, вопрос, обещание продолжения), чтобы досмотрели/дочитали и вернулись.
- КОНКРЕТИКА вместо абстракций. Имя, точное время, сумма, место, эмоция. Не «человек ненавидит работу», а «Саня едет в 7 утра в метро на работу за 30к, ненавидит жизнь, но боится уволиться». Цифры, детали и живые образы - всегда сильнее общих слов.
- Заходи через ЛИЧНОЕ и МНЕНИЕ: «моя мысль - и вот как», «моё мнение», личный опыт и позиция. Пример тона: «я стал ворчливым дедом в 35, и вот что меня бесит». Говори от себя, с характером, а не отстранённо.
- Виральный нерв - ПРОВОКАЦИЯ, АБСУРД или ЖЁСТКИЙ КОНФЛИКТ (острый неожиданный угол, контринтуитив, спор с общепринятым) - но без токсичности, треша и оскорблений. Задевай, удивляй, спорь - по-умному.
- УБИВАЙ БАНАЛЬНЫЕ ЗАГОЛОВКИ. Не «топ-5 книг для саморазвития», а «я прочитала 152 книги, чтобы стать успешной. Большинство из них - мусор, который развивает только тревожку. Но вот эти 5 реально работают». Переворачивай через личный опыт, конкретную цифру, контр-мнение или признание.
"""
