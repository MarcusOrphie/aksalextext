...
- ЖИВОЙ ТЕКСТ, НЕ ИИ. Пиши полноценными связными предложениями живой человеческой речью. НЕ руби текст на короткие телеграфные фразы ради «ритма». Никакого «ИИ-юмора», натужных шуток, восклицаний-штампов и симметричных конструкций «не X, а Y» в каждой строке. Читатель должен думать, что это писал живой человек, а не нейросеть. Лучше одно настоящее предложение, чем три обрубка.
...
- LIVING TEXT, NOT AI. Write in full, connected sentences in a lively human voice. Do NOT chop text into short telegraphic fragments for "rhythm". No "AI humor", forced jokes, cliche exclamations, or the symmetric "not X, but Y" construction in every line. The reader must believe a real human wrote this, not an AI. One real sentence beats three stubs.
...
PLATFORM = {
    ...
    "carousel":    "Платформа: Instagram карусель. Собери одну сильную карусель по теме: hook_slide (крючок первого слайда - живая цепляющая фраза до ~12 слов), slides (5-7 слайдов; у каждого title в 2-5 слов и text - 2-3 живых связных предложения естественной человеческой речью, примерно 30-55 слов), cta_slide (финальный призыв до ~16 слов). Пиши живо и по-настоящему, как рассказал бы близкому: без рубленых телеграфных фраз, без ИИ-штампов и натужных шуток. Каждое предложение по делу, но человеческим языком, а не набором обрубков.",
    ...
    "stories":     "Платформа: Instagram Stories. Собери последовательность сторис по теме ОТ ЛИЦА АВТОРА, в его личной закулисной интонации (используй личность и тон автора из профиля). frames - 4-7 кадров, по аналогии со слайдами карусели у каждого: title (короткий заголовок кадра, 2-5 слов, крупным шрифтом - цепляет взгляд) и text (живая реплика от первого лица, 1-2 естественных предложения, примерно 15-35 слов - как будто автор делится в моменте, без рубленых фраз и ИИ-штампов). Заголовок цепляет, текст раскрывает мысль.",
...
PLATFORM_EN = {
    ...
    "carousel":    "Platform: Instagram carousel. Build one strong carousel on the topic: hook_slide (the first slide's hook - a lively grabbing line up to ~12 words), slides (5-7 slides; each with a title of 2-5 words and text - 2-3 lively connected sentences in a natural human voice, about 30-55 words), cta_slide (final call up to ~16 words). Write it alive and real, the way you'd tell a close friend: no chopped telegraphic fragments, no AI cliches or forced jokes. Every sentence earns its place, but in human language, not a pile of stubs.",
    ...
    "stories":     "Platform: Instagram Stories. Build a sequence of stories on the topic IN THE AUTHOR'S FIRST PERSON, in their personal behind-the-scenes tone (use the author's personality and tone from the profile). frames - 4-7 frames, like carousel slides each has: title (a short frame heading, 2-5 words, in large type - catches the eye) and text (a lively first-person line, 1-2 natural sentences, about 15-35 words - as if the author is sharing in the moment, no chopped fragments or AI cliches). The heading hooks, the text unfolds the thought.",
