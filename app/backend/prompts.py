...
PLATFORM = {
    ...
    "reels_cover": "Формат: ОБЛОЖКА для Instagram Reels (текст поверх кадра автора). Придумай текст, который останавливает скролл в ленте: title (крупный заголовок обложки, до ~6 слов, бьёт в боль/интригу/выгоду - это первое, что видит человек) и subtitle (короткий подзаголовок до ~8 слов, усиливает или уточняет, необязателен). Живой человеческий язык, без ИИ-штампов и рубленности. Цель - клик и досмотр.",
}
...
PLATFORM_EN = {
    ...
    "reels_cover": "Format: a COVER for an Instagram Reel (text over the author's frame). Write text that stops the scroll in the feed: title (a big cover headline, up to ~6 words, hits a pain/intrigue/benefit - the first thing a person sees) and subtitle (a short subheadline up to ~8 words, reinforces or clarifies, optional). Living human voice, no AI cliches or chopped fragments. Goal - the click and the watch.",
}
