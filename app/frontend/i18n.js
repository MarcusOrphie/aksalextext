...
(function () {
  var DICT = {
    ru: {
      ...
      tip1_t: "Ритм для роста", tip1_b: "В день: 1 видео, 1 пост или карусель и 1 короткое видео в пробные Reels.",
      tip2_t: "Первые 3 секунды решают всё", tip2_b: "Цепляй в первом кадре, без «привет, это снова я». Не зацепила за 3 секунды - дальше не досмотрят.",
      tip3_t: "Снимай про запас", tip3_b: "За один присест сними 3-5 роликов, потом разложишь по дням. Меньше выгорания, стабильнее выход.",
      tip4_t: "Один Reels - одна мысль", tip4_b: "Не пихай пять идей в 30 секунд. Одна ясная мысль запоминается, каша - нет.",
      tip5_t: "Карусель держит дольше", tip5_b: "Первый слайд-крючок, дальше по одной пользе на слайд, финал - призыв сохранить или шэрнуть.",
      tip6_t: "Сохранения и шэры важнее лайков", tip6_b: "Алгоритм любит то, что хочется переслать подруге. Делай «сохраняшки»: чек-листы, подборки, шпаргалки.",
      tip7_t: "Отвечай на комменты в первый час", tip7_b: "Особенно на новых Reels: это разгоняет охваты, пока ролик на разгоне.",
      tip8_t: "Тренд бери, пока свежий", tip8_b: "Звук или формат работает первые дни. Опоздала на неделю - эффект уже слабее.",
    ...
    en: {
      ...
      tip1_t: "Rhythm for growth", tip1_b: "Per day: 1 video, 1 post or carousel, and 1 short test Reel.",
