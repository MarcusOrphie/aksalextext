...
(function () {
  var DICT = {
    ru: {
      ...
      auth_lead_reg: "Зарегистрируйся - и получи первый готовый пост за 10 минут.",
      ...
      grp_text: "Текст и сценарии", grp_visual: "Визуал — картинки (Pro)",
    ...
    en: {
      ...
      auth_lead_reg: "Sign up - and get your first ready post in 10 minutes.",
      ...
      grp_text: "Text & scripts", grp_visual: "Visuals — images (Pro)",
