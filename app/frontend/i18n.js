...
(function () {
  var DICT = {
    ru: {
      ...
      redo_btn: "Переделать", redo_ph: "что именно переделать?", redo_go: "Готово", redo_wait: "Переделываю...", redo_fail: "Не получилось, попробуй ещё раз.", redo_pro: "Переделка доступна на тарифе Pro.",
    ...
    en: {
      ...
      redo_btn: "Redo", redo_ph: "what exactly to change?", redo_go: "Done", redo_wait: "Redoing...", redo_fail: "Didn't work, try again.", redo_pro: "Redo is available on the Pro plan.",
      car_zipping: "Zipping...",
