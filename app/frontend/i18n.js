...
(function () {
  var DICT = {
    ru: {
      ...
      pw_pro_sub: "до 30 тем и сценариев в день + всё включено", pw_pro_cta: "Оформить Pro · 2499 ₽/мес",
      ...
      redo_btn: "Переделать", redo_ph: "что именно переделать?", redo_go: "Готово", redo_wait: "Переделываю...",
    ...
    en: {
      ...
      pw_pro_sub: "up to 30 topics & scripts per day + everything included", pw_pro_cta: "Get Pro · $24.99/mo",
      ...
      redo_btn: "Redo", redo_ph: "what exactly to change?", redo_go: "Done", redo_wait: "Redoing...",
