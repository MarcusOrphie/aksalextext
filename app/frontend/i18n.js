...
(function () {
  var DICT = {
    ru: {
      ...
      lay_h: "Шаблон раскладки", lay_poster_bottom: "Текст снизу", lay_poster_top: "Текст сверху", lay_poster_center: "Текст посередине", lay_band: "Текст на плашке", lay_minimal: "Крупный текст",
      pe_h: "Фото и шаблон для каждого слайда", pe_add: "Добавить фото",
      mine_use: "Использовать мои фото", mine_on: "Использую мои фото", mine_hint: "Загрузи свои фото - по одной на каждый слайд, у каждой свой шаблон текста",
    ...
    en: {
      ...
      lay_h: "Layout template", lay_poster_bottom: "Text at bottom", lay_poster_top: "Text at top", lay_poster_center: "Text in the middle", lay_band: "Text on band", lay_minimal: "Big text",
      pe_h: "Photo and template for each slide", pe_add: "Add photo",
      mine_use: "Use my photos", mine_on: "Using my photos", mine_hint: "Upload your photos - one per slide, each with its own text style",
