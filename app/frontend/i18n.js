...
(function () {
  var DICT = {
    ru: {
      ...
      cd_coral: "Коралл", cd_cream: "Крем", cd_ink: "Тёмный", cd_sunset: "Закат", cd_mint: "Мята",
      cd_noir: "Нуар", cd_paper: "Бумага", cd_blush: "Румяна", cd_sky: "Небо", cd_forest: "Лес", cd_custom: "Мой дизайн",
      // dynamic (app.js)
    ...
    en: {
      ...
      cd_coral: "Coral", cd_cream: "Cream", cd_ink: "Dark", cd_sunset: "Sunset", cd_mint: "Mint",
      cd_noir: "Noir", cd_paper: "Paper", cd_blush: "Blush", cd_sky: "Sky", cd_forest: "Forest", cd_custom: "My design",
