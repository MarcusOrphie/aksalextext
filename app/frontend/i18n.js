...
(function () {
  var DICT = {
    ru: {
      ...
      redo_btn: "Переделать", redo_ph: "что переделать? напр: шрифт больше/меньше, текст выше/ниже/левее/правее", redo_go: "Готово", redo_wait: "Переделываю...", redo_fail: "Не получилось, попробуй ещё раз.", redo_pro: "Переделка доступна на тарифе Pro.", sticker_btn: "Своё фото", sticker_change: "Заменить фото", sticker_remove: "убрать фото",
    ...
    en: {
      ...
      redo_btn: "Redo", redo_ph: "what to change? e.g. bigger/smaller font, text up/down/left/right", redo_go: "Done", redo_wait: "Redoing...", redo_fail: "Didn't work, try again.", redo_pro: "Redo is available on the Pro plan.", sticker_btn: "Your photo", sticker_change: "Change photo", sticker_remove: "remove photo",
      car_zipping: "Zipping...",
